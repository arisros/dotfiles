...
return {
	...
	keys = {
		...
		-- Specs under generated/ appear only after the codegen step - refresh picks them
	...
	config = function()
		...
		local adapter = playwright.adapter({
			options = {
				...
				-- The suite drives playwright through bun, so there is no global
				...
				-- env-scoped testMatch are honored. Those variables are
