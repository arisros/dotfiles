#!/usr/bin/env bash
# On-screen state for the Karabiner browser prefix layer (karabiner).
#
...
ARMED="0xfff38ba8"   # $RED, sketchybar/colors.sh
IDLE="0xffCC6766"    # active_color, borders/bordersrc
