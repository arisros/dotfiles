...
mkdir -p "$AGENT_DIR" "$SKILLS_DIR/backend-engineer" "$SKILLS_DIR/frontend-engineer"
...
- `agent/project-architect.md` - planner-style project agent
- `skills/backend-engineer/skill.yaml` - backend-focused skill defaults
- `skills/frontend-engineer/skill.yaml` - frontend-focused skill defaults
EOF

cat > "$AGENT_DIR/project-architect.md" <<'EOF'
---
description: >-
...
cat > "$SKILLS_DIR/backend-engineer/skill.yaml" <<'EOF'
...
cat > "$SKILLS_DIR/frontend-engineer/skill.yaml" <<'EOF'
