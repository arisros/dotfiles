...
export GREY_100=0xff666666
export GREY_300=0xff888888
export GREY_400=0xff484848
export GREY_500=0xff282828
export BAR="$BLACK"
export OFF="$TEXT"
export ON=0xff00ff00
export ACTIVE=0xffa6e3a1 # selection background

export GROUP="$GREY_100"
export EVEN_SPACE="$GREY_400"
export ODD_SPACE="$GREY_500"
export DIVIDER="$GREY_300"
